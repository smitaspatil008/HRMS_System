...
INSERT INTO `user_role_table` VALUES (1,'Director','Director role with higher-level management access'),(2,'HR_Admin','HR Administrator role with access to employee management'),(3,'Support','Support role with access to user tickets and requests'),(4,'Admin','Administrator with full access');
